      ...
      <div className="container">
        <div className="flex items-center justify-between py-4">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a href="mailto:support@andersoncarlconsultancy.uk" className="text-gray-600 hover:text-blue-900">
        ...
        <div className={`md:hidden transition-all duration-300 overflow-hidden ${isMenuOpen ? 'max-h-screen pb-6' : 'max-h-0'}`}>
          <nav className="space-y-4">
            ...
            <div className="pt-4 border-t">
              <a href="mailto:support@andersoncarlconsultancy.uk" className="block text-gray-600 mb-3">
                📧 support@andersoncarlconsultancy.uk
              </a>
