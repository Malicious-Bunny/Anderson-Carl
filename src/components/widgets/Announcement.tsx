...
const Announcement = () => {
  ...
  return (
    <div className="hidden overflow-hidden text-ellipsis whitespace-nowrap border-b border-primary-950 bg-primary-950 px-3 py-2 text-sm text-gray-200 md:block">
      <span className="bg-gold-600 py-0.5 px-1 text-xs font-semibold">{title}</span>{' '}
