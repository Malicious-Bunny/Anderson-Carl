...
const Footer = () => {
  ...
  return (
    <footer className="bg-primary-950 text-white">
      {/* WhatsApp banner */}
      <div className="bg-[#1da851] py-4">
        <div className="container-custom flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-white font-semibold text-sm">
            Need help? We reply within minutes on WhatsApp.
          </p>
          <a
            href={WA_URL}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-5 py-2 bg-white text-[#1da851] font-bold text-sm rounded-xl transition-all duration-200 hover:bg-green-50 cursor-pointer flex-shrink-0"
          >
            <WhatsAppIcon />
            Chat Now
          </a>
