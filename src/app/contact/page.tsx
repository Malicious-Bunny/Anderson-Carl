        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <form
                className="space-y-6"
                action="mailto:support@andersoncarlconsultancy.uk?subject=New Document Consultation Request - Anderson Carl Website"
                method="post"
                encType="text/plain"
              >
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        <a href="mailto:support@andersoncarlconsultancy.uk" className="hover:text-blue-900">
                          support@andersoncarlconsultancy.uk
                        </a>
                      </p>
