...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'Anderson Carl UK consultant',
    'passport application UK fast',
    'UK driver licence no test',
    'IELTS certificate UK no test',
    'PTE certificate UK no test',
    ...
    'UK document consultation',
    'British document services',
    'UK immigration documents',
    'certificate services UK'
  ],
  openGraph: {
    title: 'Anderson Carl - UK Documents Specialist | Professional Document Consultation',
    description: 'Expert UK document services with 99% success rate. Fast passport applications, driver licences with no test required, IELTS/PTE certificates, and civil documents.',
    images: ['/headshot.jpg'],
    url: '/',
  },
  alternates: {
            ...
            <div className="space-y-8">
              <div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
                  UK Documents Specialist - Anderson Carl Professional Consultation Services
                </h1>
                <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl">
                  Expert UK document assistance with 99% success rate. Fast passport applications (4 days),
                  driver licences with no test required, IELTS/PTE certificates, civil documents, and immigration services.
                  Streamline your UK applications with professional consultation available 24/7.
                </p>
              </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white rounded-lg p-6 shadow-md inline-block">
              ...
              <p className="text-gray-600">
                Email Us: <a href="mailto:support@andersoncarlconsultancy.uk" className="text-blue-900 hover:underline">support@andersoncarlconsultancy.uk</a>
              </p>
            </div>
          </div>
        </div>
