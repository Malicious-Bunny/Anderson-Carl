        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <nav className="text-primary-600 mb-4">
              ...
              <span className="text-primary-900 font-semibold"> Passport Application</span>
            </nav>
            ...
            <div className="bg-primary-900 text-white rounded-lg p-6 inline-block">
              ...
              <p className="text-primary-200 mb-2">Processing Time: 4 days</p>
              <p className="text-primary-200">Complete passport application assistance</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  <span className="text-2xl mr-4">🔄</span>
                  <div>
                    <h3 className="text-xl font-semibold text-primary-900 mb-2">Renewal Assistance</h3>
                    <p className="text-gray-700">
            ...
            <div className="bg-gray-50 rounded-lg p-8">
              ...
              <div className="bg-primary-900 text-white rounded-lg p-6 mb-6">
                ...
                <div className="mb-3">
                  <p className="text-primary-200">• New Application: £1,500</p>
                  <p className="text-primary-200">• Renewal Service: £500</p>
                  <p className="text-primary-200">• Lost/Stolen Replacement: £1,500</p>
                  <p className="text-primary-200 mt-2"><strong>Processing Time: 4 days</strong></p>
                </div>
              ...
              <div className="space-y-4">
                ...
                <a
                  href="https://wa.me/447529418057?text=Hello Anderson Carl, I need assistance with UK passport application."
                  target="_blank"
      ...
      <section className="py-16 bg-gray-50">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-primary-900 mb-4">Our Passport Application Process</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-primary-900 mb-3">Initial Consultation</h3>
              <p className="text-gray-700">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-primary-900 mb-3">Follow-up & Delivery</h3>
              <p className="text-gray-700">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-primary-900 mb-3">How long does the passport application process take?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-primary-900 mb-3">What are the current UK passport fees?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-primary-900 mb-3">Can you help with urgent passport applications?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-primary-900 mb-3">What if my application is rejected?</h3>
                <p className="text-gray-700">
