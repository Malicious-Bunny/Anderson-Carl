        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            <nav className="text-primary-600 mb-4">
              ...
              <span className="text-primary-900 font-semibold"> PTE Certificate</span>
            </nav>
            ...
            <div className="bg-primary-900 text-white rounded-lg p-6 inline-block">
              ...
              <p className="text-primary-200">Comprehensive PTE certification assistance</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  <span className="text-2xl mr-4">📄</span>
                  <div>
                    <h3 className="text-xl font-semibold text-primary-900 mb-2">Score Verification</h3>
                    <p className="text-gray-700">
            ...
            <div className="bg-gray-50 rounded-lg p-8">
              <h3 className="text-2xl font-bold text-primary-900 mb-6">PTE Test Features</h3>
              ...
              <div className="space-y-4">
                ...
                <a
                  href="https://wa.me/447529418057?text=Hello Anderson Carl, I need assistance with PTE certification."
                  target="_blank"
      ...
      <section className="py-16 bg-gray-50">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-primary-900 mb-4">Our PTE Support Process</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-primary-900 mb-3">Score Assistance</h3>
              <p className="text-gray-700">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-primary-900 mb-3">What PTE score do I need for UK immigration?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-primary-900 mb-3">How much does the PTE Academic test cost?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-primary-900 mb-3">How long are PTE Academic scores valid?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-primary-900 mb-3">Can I retake PTE Academic if needed?</h3>
                <p className="text-gray-700">
