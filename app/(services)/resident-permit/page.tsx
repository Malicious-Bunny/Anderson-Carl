        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 rounded-lg p-6 inline-block">
              ...
              <p className="text-primary-200">Comprehensive residence permit assistance</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  <span className="text-2xl mr-4">🏡</span>
                  <div>
                    <h3 className="text-xl font-semibold text-primary-900 mb-2">Residency Proof</h3>
                    <p className="text-gray-700">
            ...
            <div className="bg-gray-50 rounded-lg p-8">
              ...
              <div className="space-y-4">
                ...
                <a
                  href="https://wa.me/447529418057?text=Hello Anderson Carl, I need assistance with UK residence permit application."
                  target="_blank"
      ...
      <section className="py-16 bg-gray-50">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-primary-900 mb-4">Our Residence Permit Process</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-primary-900 mb-3">Eligibility Assessment</h3>
              <p className="text-gray-700">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-primary-900 mb-3">How long does the residence permit process take?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-primary-900 mb-3">What are the current residence permit fees?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-primary-900 mb-3">Do I need to take the Life in the UK test?</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-primary-900 mb-3">What if my application is refused?</h3>
                <p className="text-gray-700">
